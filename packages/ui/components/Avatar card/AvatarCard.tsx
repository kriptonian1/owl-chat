      ...
      <div className="flex items-center bg-stone-900 w-96 justify-between p-4 rounded ">
        ...
        <Avatar src={src} alt={alt} active={active} />
          <div className="flex flex-col pl-5">
            <h1 className="text-white text-xl whitespace-nowrap w-40 overflow-hidden text-ellipsis">{name}</h1>
            <p className="text-slate-500 whitespace-nowrap w-40 overflow-hidden text-ellipsis">{message}</p>
          </div>
        </div>
